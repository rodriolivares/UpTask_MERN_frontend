...
const ModalEliminarColaborador = () => {
   ...
   const { modalElminarColaborador, handleModalEliminarColaborador, eliminarColaborador } = useProyectos()
 
   return (
      <Transition.Root show={ modalElminarColaborador } as={Fragment}>
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                           ...
                           <div className="mt-2">
                              <p className="text-sm text-gray-500">
                                 Una colaborador eliminado no se podra recuperar, y tendrías que agregarlo de nuevo.
                              </p>
                           </div>
                        </div>
                     </div>
