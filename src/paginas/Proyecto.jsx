      ...
      <>   
         ...
         <div className="bg-white shadow mt-10 rounded-lg">
            { proyecto.tareas?.length ? 
               ...
               <p className="text-centeer my-5 p-10">No hay Tareas en este Proyecto</p> }
         </div>
         ...
         {admin && ( <>
            ...
            <div className="bg-white shadow mt-10 rounded-lg">
               { proyecto.colaboradores?.length ? 
                  ...
                  <p className="text-centeer my-5 p-10">No hay Colaboradores en este Proyecto</p> }
            </div>
         </> )}
